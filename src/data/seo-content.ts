...
// Written for the UAE (Dubai, Abu Dhabi), and UK markets in a premium brand voice.
...
export const SEO_CONTENT: Record<string, SeoBlock> = {
    ...
    homepage: {
        ...
        faqs: [
            { q: "Where does Enjoyful Life deliver?", a: "We deliver across the United Arab Emirates — including Dubai, Abu Dhabi, Sharjah and the Northern Emirates — and offer international shipping to the United Kingdom. Delivery times and any free-shipping thresholds are shown at checkout." },
    ...
    glow: {
        ...
        paragraphs: [
            "Our Glow Collection is dedicated to facial care that brightens, balances and refines. From gentle cleansers and exfoliating scrubs to hydrating masks, toners and protective sunscreen, each formula is built to support a clear, luminous complexion in the demanding climate of the UAE and beyond.",
    ...
    daily: {
        ...
        paragraphs: [
            ...
            "Life in Dubai, Abu Dhabi and across the UAE — sun, heat, frequent washing and hard water — can leave skin tight and hair dry. Our formulas are designed to restore comfort and shine without heaviness, using naturally derived ingredients and lightweight textures that suit both the Gulf climate and the UK's cooler conditions.",
        ...
        faqs: [
            ...
            { q: "How quickly will my order arrive?", a: "We deliver across the UAE with fast, reliable shipping, and offer delivery to the UK. Estimated timing and any free-shipping threshold appear at checkout." },
    ...
    fragrances: {
        ...
        paragraphs: [
            "Our Fragrance Collection is composed for those who appreciate scent as a form of self-expression. From eau de parfums to refreshing body mists, roll-ons and deodorising sticks, each fragrance is crafted to feel refined, lasting and beautifully balanced — at home in Dubai, Abu Dhabi and the UK alike.",
        ...
        faqs: [
            ...
            { q: "Do you deliver fragrances across the UAE and UK?", a: "Yes. We deliver throughout the UAE and ship to the UK, with details shown at checkout." },
    ...
    home: {
        ...
        faqs: [
            ...
            { q: "Do you deliver home fragrance across the UAE?", a: "Yes — we deliver throughout the UAE, including Dubai and Abu Dhabi, and ship to the UK." },
    ...
    about: {
        ...
        paragraphs: [
            ...
            "Everything we make is shaped by the people and places we serve. Our home market — Dubai, Abu Dhabi and the wider Emirates — is hot, humid and fast-moving, so our textures are lightweight and fast-absorbing, our fragrances are built to last in the heat, and our routines are designed to be simple enough to keep. That same considered approach travels well to the UK, where customers value the same balance of efficacy and care.",
            ...
            "Above all, Enjoyful Life is about how good, dependable care makes daily life feel a little more enjoyable. We are grateful to the customers across the Emirates and the UK who have made us part of their routines, and we remain committed to earning that trust with every formula we create.",
        ],
        links: [
            ...SHARED_LINKS,
        ...
        faqs: [
            { q: "What is Enjoyful Life?", a: "Enjoyful Life is a premium personal-care brand offering naturally derived skincare, body and hair care, baby care, fragrances and home wellness, serving customers across the UAE and the UK." },
            ...
            { q: "Where are your products available?", a: "You can shop the full range on our website, with delivery across the UAE and shipping to the UK." },
    ...
    contact: {
        ...
        paragraphs: [
            "Whether you have a question about a product, need help choosing the right routine for your skin, or want to check on an order, the Enjoyful Life team is here for you. We support customers across the UAE — including Dubai and Abu Dhabi — as well as the UK, and we aim to respond quickly and helpfully.",
