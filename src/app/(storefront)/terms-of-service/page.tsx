                ...
                >
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h2 className="editorial-section-heading text-xl text-[var(--color-brand-onyx)]">2. Orders, Pricing &amp; Currency</h2>
                        </div>
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h2 className="editorial-section-heading text-xl text-[var(--color-brand-onyx)]">3. Payments &amp; Security</h2>
                        </div>
                        <p>
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h2 className="editorial-section-heading text-xl text-[var(--color-brand-onyx)]">4. Intellectual Property</h2>
                        </div>
                        <p>
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h2 className="editorial-section-heading text-xl text-[var(--color-brand-onyx)]">5. Governing Law &amp; Jurisdiction</h2>
                        </div>
                        <p>
