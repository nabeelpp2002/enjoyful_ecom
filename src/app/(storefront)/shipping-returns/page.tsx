        ...
        <div className="bg-[var(--color-brand-sand)] min-h-screen pb-16 sm:pb-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
                ...
                >
                    ...
                    <p className="mt-3 editorial-body text-xs sm:text-sm text-[var(--color-brand-onyx)]/70 max-w-xl mx-auto">
                ...
                <div className="space-y-8">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="editorial-section-heading text-xl sm:text-2xl text-[var(--color-brand-onyx)]">UAE Shipping &amp; Delivery</h2>
                                <p className="editorial-body text-xs text-[var(--color-brand-onyx)]/60">Fast, reliable fulfillment across all Emirates</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div className="p-4 bg-[var(--color-brand-sand)]/60 rounded-2xl border border-white/60">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <h3 className="editorial-heading font-bold text-sm text-[var(--color-brand-onyx)]">Dubai &amp; Abu Dhabi</h3>
                                </div>
                                <p className="editorial-body text-xs text-[var(--color-brand-onyx)]/70">Standard Delivery: 1 – 2 Business Days</p>
                            </div>

                            <div className="p-4 bg-[var(--color-brand-sand)]/60 rounded-2xl border border-white/60">
                                <div className="flex items-center gap-2 mb-1">
                                    <Clock className="w-4 h-4 text-[var(--color-brand-purple)]" />
                                    <h3 className="editorial-heading font-bold text-sm text-[var(--color-brand-onyx)]">Other Emirates</h3>
                                </div>
                                <p className="editorial-body text-xs text-[var(--color-brand-onyx)]/70">Sharjah, Ajman, RAK, Fujairah: 2 – 3 Business Days</p>
                            </div>
                        </div>

                        <div className="space-y-3 editorial-body text-xs sm:text-sm text-[var(--color-brand-onyx)]/80 leading-relaxed">
                            <p>
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="editorial-section-heading text-xl sm:text-2xl text-[var(--color-brand-onyx)]">14-Day Return &amp; Refund Policy</h2>
                                <p className="editorial-body text-xs text-[var(--color-brand-onyx)]/60">Compliant with UAE Consumer Protection Law</p>
                            </div>
                        </div>

                        <div className="space-y-4 editorial-body text-xs sm:text-sm text-[var(--color-brand-onyx)]/80 leading-relaxed mb-6">
                            <p>
                            ...
                            <div className="p-4 bg-white rounded-2xl border border-[var(--color-brand-onyx)]/10 space-y-2">
                                <h4 className="editorial-label font-bold text-xs uppercase tracking-wider text-[var(--color-brand-purple)]">Return Conditions</h4>
