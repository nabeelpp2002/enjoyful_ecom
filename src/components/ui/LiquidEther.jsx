...
`;
        ...
        // Make WebGL fill the container and position absolute if possible
        ...
        // Quick fix to ensure canvas stretches properly. Renderer places canvas inside.
        const canvasObj = container.querySelector('canvas');
        if (canvasObj) {
            canvasObj.style.position = 'absolute';
            canvasObj.style.top = '0';
            canvasObj.style.left = '0';
            canvasObj.style.zIndex = '1';
            // This will stay below other absolutely positioned content if they have zIndex >= 2.
        }
