  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-[5]">
      ...
      >
        {isDesktop ? (
          <>
            ...
            <div
              ...
              style={{ height: "12%" }}
            >
              <span className="editorial-label absolute left-2 top-1 text-[9px] font-semibold uppercase tracking-wide text-sky-100">
                Header overlay
              </span>
            </div>
            ...
            <div
              ...
              style={{ width: "55%" }}
            >
              <span className="editorial-label absolute left-2 top-[14%] text-[9px] font-semibold uppercase tracking-wide text-amber-100">
                Text &amp; CTA
              </span>
            </div>
            ...
            <div
              ...
              style={{ width: "45%" }}
            >
              <span className="editorial-label absolute right-2 top-[14%] text-[9px] font-semibold uppercase tracking-wide text-emerald-100 text-right">
                Product &amp; branding
              </span>
            </div>
            ...
            <div className="absolute inset-x-0 bottom-0 h-[8%] border-t border-red-400/40 bg-red-500/5">
              <span className="editorial-label absolute bottom-1 left-1/2 -translate-x-1/2 text-[8px] font-medium uppercase tracking-wide text-red-200/90 whitespace-nowrap">
          ...
          <>
            ...
            >
              <span className="editorial-label absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[9px] font-semibold uppercase tracking-wide text-emerald-100 text-center">
                Subject safe
              </span>
            </div>
            ...
            <div
              ...
              style={{ height: "25%" }}
            >
              <span className="editorial-label absolute left-2 top-2 text-[9px] font-semibold uppercase tracking-wide text-amber-100">
                Text &amp; bottom nav
              </span>
            </div>

            <div className="absolute inset-x-0 bottom-[25%] h-[6%] border-t border-red-400/40 bg-red-500/5">
              <span className="editorial-label absolute top-0.5 left-1/2 -translate-x-1/2 text-[8px] font-medium uppercase tracking-wide text-red-200/90 whitespace-nowrap">
                May crop on some screens
              </span>
            </div>
          </>
        ...
        >
          <span className="editorial-label absolute -top-4 left-0 text-[8px] font-medium uppercase tracking-wide text-white/70">
            Core safe area
          </span>
        </div>
      </div>
