...
export function SkinDeservesSection() {
    return (
        <section className="bg-[#f5f4ef] py-16 sm:py-20 lg:py-14">
            <div className="mx-auto max-w-6xl px-5 sm:px-8">
                <div className="mb-8 flex flex-col gap-5 md:mb-10 md:flex-row md:items-end md:justify-between lg:mb-8">
                    <div>
                ...
                <div className="grid gap-4 lg:grid-cols-[1.18fr_.82fr] lg:grid-rows-2">
                    <article className="group sticky top-[18svh] z-10 h-[440px] overflow-hidden rounded-[1.75rem] shadow-[0_12px_32px_rgba(31,28,24,.08)] sm:h-[570px] md:relative md:top-auto md:z-auto md:h-auto md:min-h-[570px] md:shadow-none lg:row-span-2 lg:h-[460px] lg:min-h-0">
                        <Image src="/assets/skin-deserves-editorial.png" alt="Healthy, naturally radiant skin" fill sizes="(max-width: 767px) 100vw, 1px" className="object-cover transition-transform duration-700 group-hover:scale-[1.025] md:hidden" />
                        <Image src="/assets/skin-deserves-editorial-wide.webp" alt="Healthy, naturally radiant skin" fill sizes="(max-width: 1199px) 58vw, 680px" className="hidden object-cover object-center transition-transform duration-700 group-hover:scale-[1.025] md:block" />
                    ...
                    <article className="sticky top-[18svh] z-20 h-[440px] overflow-hidden rounded-[1.75rem] bg-[#e7e2d8] p-7 shadow-[0_12px_32px_rgba(31,28,24,.08)] sm:h-[570px] sm:p-9 md:relative md:top-auto md:z-auto md:h-auto md:min-h-[310px] md:shadow-none lg:h-[222px] lg:min-h-0 lg:p-7">
                        ...
                        <div className="relative z-10 max-w-[48%]">
                            ...
                            <h3 className="editorial-section-heading text-3xl text-[var(--color-brand-onyx)] sm:text-4xl lg:text-[30px]">Skin-loving essentials</h3>
                    ...
                    <article className="sticky top-[18svh] z-30 h-[440px] overflow-hidden rounded-[1.75rem] bg-[#33412f] p-7 text-white shadow-[0_12px_32px_rgba(31,28,24,.08)] sm:h-[570px] sm:p-9 md:relative md:top-auto md:z-auto md:h-auto md:min-h-[310px] md:shadow-none lg:h-[222px] lg:min-h-0 lg:p-7">
                        ...
                        <div className="relative z-10 flex h-full max-w-sm flex-col justify-between">
                            ...
                            <div className="mt-16">
                                ...
                                <h3 className="editorial-section-heading text-4xl sm:text-5xl lg:text-[34px]">100% inspired by natural goodness</h3>
